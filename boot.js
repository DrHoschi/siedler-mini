...
// --- NEU: Public API für alternative UI-Bindings (ui.js) ---
if (typeof window !== 'undefined') {
  window.gameAPI = {
    ...
    center() {
      try { game.center?.(); } catch(e){ console.error(e); }
    },
    setTool(name) {
      try { game.setTool?.(name); } catch(e){ console.error(e); }
    },
    fullscreen() {
      try {
        const el = document.documentElement;
