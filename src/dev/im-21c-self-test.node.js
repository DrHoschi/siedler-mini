...
assert.match(config, /IM-21(?:C-BUILD-CATALOG-PLACEMENT-PLAYER-UX|D-WORK-AREA-PLAYER-UX)-INTEGRATION-TESTBUILD-1/, 'IM-21C contract may run under the authorized IM-21D successor runtime build identity');
