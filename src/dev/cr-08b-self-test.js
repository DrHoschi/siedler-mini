...
export function runCr08bSelfTest() {
  ...
  check('partial-step-moves-deterministically-on-direct-line',()=>{const next=DirectTargetMovementExecution.advance(moving,2);return next.state==='MOVING'&&next.currentPosition.x===1.2&&next.currentPosition.y===1.6&&next.targetPosition.x===3&&next.targetPosition.y===4;});
