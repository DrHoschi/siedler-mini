...
const map = new MapStructure(world, {
  name: 'CR-02B Resource Claim Foundation Map',
  width: 8,
  height: 8,
  cellSize: 1,
  metadata: { foundation: 'CR-02B' }
});
...
const pass = foundationReport.pass && cr01aReport.pass && cr01bReport.pass && cr01cReport.pass && freezeGateReport.pass && cr02aReport.pass && cr02bReport.pass;

if (testEl) testEl.textContent = pass ? 'CR-02B SELF-TEST: PASS' : 'CR-02B SELF-TEST: FAIL';
...
console.info('[CR-02B] Resource Reservation & Claim Contract READY', {
