...
const map=new MapStructure(world,{name:'CR-08C Movement ↔ Transport Execution Integration',width:8,height:8,cellSize:1,metadata:{foundation:'CR-08C-MOVEMENT-TRANSPORT-EXECUTION-INTEGRATION'}});
