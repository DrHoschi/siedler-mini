...
const map = new MapStructure(world, {
  name: 'CR-02C Resource Demand Foundation Map',
  width: 8,
  height: 8,
  cellSize: 1,
  metadata: { foundation: 'CR-02C' }
});
...
const pass = foundationReport.pass && cr01aReport.pass && cr01bReport.pass && cr01cReport.pass && freezeGateReport.pass && cr02aReport.pass && cr02bReport.pass && cr02cReport.pass;

if (testEl) testEl.textContent = pass ? 'CR-02C SELF-TEST: PASS' : 'CR-02C SELF-TEST: FAIL';
...
console.info('[CR-02C] Resource Demand Contract READY', {
