...
const map=new MapStructure(world,{name:'CR-08 Carrier Movement Foundation Freeze Gate',width:8,height:8,cellSize:1,metadata:{foundation:'CR-08-CARRIER-MOVEMENT-FOUNDATION-FREEZE-GATE'}});
