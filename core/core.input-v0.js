 ...
 * Version : v25.11.14-final2 (ghost-anchored, camera-aware, tagged place)
 ...
 *  - Setzt window.__SIEDLER_PLACE_ACTIVE = true/false für Kamera-Glue (Pan/Zoom sperren)
 * ========================================================================== */
(() => {
  'use strict';
  ...
  function resetTool(){
    ...
    // Globale Info für Kamera-Glue: Platziermodus ist beendet
  ...
  function bindGlobal(){
    addEventListener('cb:set-build-tool', (ev)=>{
      ...
      // Globale Flag für Kamera-Glue setzen:
      // true = Platziermodus aktiv, Kamera soll Pointer ignorieren
  ...
  function init(){
    ...
    // Beim Start ist kein Platziermodus aktiv
    window.__SIEDLER_PLACE_ACTIVE = false;

    OK('bereit v25.11.14-final2 (ghost-anchored, camera-aware)');
  }
