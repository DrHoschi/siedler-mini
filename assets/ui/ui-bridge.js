/* =============================================================================
   ...
   Zweck:
     - Inspector-Button → vorhandenen Inspector anbinden (ALT + NEU + Events + Root-Fallback).
     - Build-Button → UIBuild.open/close/toggle oder Sichtbarkeit + Body-Klasse.
     - Kein neues UI, keine Überschreibungen.
============================================================================= */
...
(function initBridge(){
  ...
  function toggleBuild(){
    ...
    // Sanfter Fallback: Sichtbarkeit schalten + Events spiegeln
  ...
  function toggleInspector(){
    ...
    // 1) ALT (monolithisch): window.UIInspector
